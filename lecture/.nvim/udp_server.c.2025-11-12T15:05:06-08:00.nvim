...
int main() {
  ...
  while (1) {
    ...
    ssize_t ans = recvfrom(socket_fd, buff, SIZE, 0,
                           (struct sockaddr *)&ret_addr, &ret_addr_size);
